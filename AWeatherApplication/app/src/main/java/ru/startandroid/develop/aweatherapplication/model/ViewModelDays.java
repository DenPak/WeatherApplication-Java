...
public class ViewModelDays extends ViewModel {
    ...
    public LiveData<Example> getDaysLiveData() {
    ...
    public void getDaysRecycle(String q, int days) {
        ...
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.d(TAG, "responseDays success");
                } else {
                    Log.d(TAG, "responseDays error");
                }
            }

            @Override
            public void onFailure(Call<Example> call, Throwable t) {
                Log.d(TAG, "responseDays - " + call.request() + ", errorDays - " + t.getLocalizedMessage());
            }
        });
    }
}
